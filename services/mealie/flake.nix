  ...
  outputs =
    ...
    in
    {
      ...
      containers =
        ...
        {
          mealie-app = {
            rawImageReference = "ghcr.io/mealie-recipes/mealie:v3.13.1@sha256:56b30a2e46310cb942f22291f584376edb70d742847cc7657e6ed2dfd76270dc";
            nixSha256 = "sha256-WKzQlgx4JtXPAke8bSXdzzsq7lu8zZsTS2Vx4k1sxug=";
            environment = {
              # Base URL
