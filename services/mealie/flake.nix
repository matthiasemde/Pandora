  ...
  outputs =
    ...
    in
    {
      ...
      containers =
        ...
        {
          mealie-app = {
            rawImageReference = "ghcr.io/mealie-recipes/mealie:v3.14.0@sha256:6785e5ca87f0ae25f90be850fd1473e92a2c0bde1b5ef07be111c4c9565aeb75";
            nixSha256 = "sha256-6MXU2nmydhoud//bpbXAE3GErLH41nklEGegcqJEMkg=";
            environment = {
              # Base URL
