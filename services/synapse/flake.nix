    ...
    in
    {
      ...
      containers =
        ...
        in
        {
          ...
          synapse-app = {
            rawImageReference = "matrixdotorg/synapse:v1.150.0@sha256:cba0969087ca70a3ec72ebcd1491a6c8391a7da2c0b92738231dd9c7ad55df4d";
            nixSha256 = "sha256-jZiiBVa/udJOqRO3CKmfQIlTfaWexdVIafh0+FOLv9E=";
            environment = {
